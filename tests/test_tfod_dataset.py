...
from datasetutils.tfod_dataset import TFODDataset    
from datasetutils.dataset import Dataset

from utils.io import encode_jpeg, decode_jpg, read_img
from tests.config import TEST_DATSET_DIR, TEST_LOG_LEVEL
...
src_path = "/media/datasets/tag_semantic_detection/v2/source"
path = TEST_DATSET_DIR
name = "tfod_test_dataset"     
version = 1              
tgt_dtype = "uint8"      
tgt_shape = (640, 640, 3)                     
compression = 0   
...
class TestTFODDataset(unittest.TestCase):
